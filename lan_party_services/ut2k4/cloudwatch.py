...
def create_cloudwatch_resources(scope, stack_name, cluster, service, nlb, log_group):
    ...
    # Create a CloudWatch Logs subscription filter to forward the log messages to the Lambda function
