asset_file_paths = [
    ...
    ("total_annihilation/setup_total_annihilation_commander_pack_3.1_(22139).exe", "total_annihilation"),
    ("total_annihilation/total_annihilation__commander_pack_en_1_3_15733.pkg", "total_annihilation"),
