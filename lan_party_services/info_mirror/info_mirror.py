    ...
    def __init__(
        ...
        **kwargs,
        ...
        cloudfront_oai = cloudfront.OriginAccessIdentity(
            self, "cloudfrontOai", comment=f"OAI for {construct_id}"
        )
...
"""),
        ...
        my_response_headers_policy_website = cloudfront.ResponseHeadersPolicy(
            self,
            ...
            security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(
                ...
                strict_transport_security=cloudfront.ResponseHeadersStrictTransportSecurity(
                    access_control_max_age=Duration.seconds(31536000),  # 12 months
        ...
        s3_deployment.BucketDeployment(
            ...
            "DeployWebsite",
            sources=[
                s3_deployment.Source.asset("./lan_party_services/info_mirror/site")
            ],
